...
import VagaComponente from '../../components/Vaga'

// 1. Definição do Componente Estilizado para a lista
...
// 2. Renomeamos o type para evitar conflito com o componente importado
type VagaType = {
  id: number
  titulo: string
  localizacao: string
...
const vagas: VagaType[] = [
  ...
  },
  {
    ...
    salarioMin: 4000,
    salarioMax: 5000,
    requisitos: ['HTML', 'JavaScript', 'jQuery']
  }
]
